...
exports.Link = Object.assign(React.forwardRef(function (props, anchorRef) { return (React.createElement(NaviContext_1.NaviContext.Consumer, null, function (context) { return React.createElement(InnerLink, __assign({}, props, { context: context, anchorRef: anchorRef })); })); }), { Anchor: LinkAnchor });
...
var InnerLink = /** @class */ (function (_super) {
        ...
        _this.handleClick = function (event) {
            ...
            if (event.button === 0 &&
                ...
                if (!event.defaultPrevented && url) {
                    ...
                    var isSamePathname = navi_1.modifyTrailingSlash(url.pathname, 'remove') === navi_1.modifyTrailingSlash(currentURL.pathname, 'remove');
                    _this.props.context.navigation.navigate(url);
                    if ((isSamePathname || url.pathname === '') && url.hash === currentURL.hash && url.hash) {
                        scrollToHash_1.scrollToHash(currentURL.hash, 'smooth');
                    }
                }
            }
        };
    ...
    InnerLink.prototype.getURL = function () {
        ...
        if (navigationURL && typeof href === 'string') {
            href = href[0] === '/' ? href : navi_1.joinPaths('/', navigationURL.pathname, href);
        }
    ...
    InnerLink.prototype.render = function () {
        ...
        active = active !== undefined ? active : !!(linkURL &&
            ...
            (exact
                ...
                : navi_1.modifyTrailingSlash(navigationURL.pathname, 'add').indexOf(linkURL.pathname) === 0));
