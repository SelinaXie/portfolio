(function (global, factory) {
    ...
    function joinPaths(base) {
        ...
        for (var i = 0; i < paths.length; i++) {
            allSegments.push.apply(allSegments, __spread$1(splitPath(paths[i])));
        }
        var pathSegments = [];
            ...
            return __generator$2(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [5 /*yield**/, __values$1((child ? concatMatcherIterators(parentIterator, createMatcherIterator(child, request)) : parentIterator))];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4: return [2 /*return*/];
    ...
    function map(resolvableMatcher) {
        return function (child) { return function mapMatcherGenerator(request) {
            return __generator$3(this, function (_a) {
                switch (_a.label) {
                    case 0: return [5 /*yield**/, __values$2(resolveChunks(resolvableMatcher, request, function (childMatcher) { return createMatcherIterator(childMatcher(child), request); }))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
                    ...
                    switch (_a.label) {
                        ...
                        case 4:
                            childIterators = crawlTuples_1.map(function (_a, i) {
                                var _b = __read$2(_a, 2), matcher = _b[0], crawlItem = _b[1];
                                var crawlRequest = __assign$1({}, request, { mountpath: crawlItem.url.pathname, url: '', path: '' });
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all(Object.entries(paths).map(function (_a) {
                                var _b = __read$2(_a, 2), pattern = _b[0], matcher = _b[1];
            ...
            return __generator$5(this, function (_a) {
                switch (_a.label) {
                    case 0: return [5 /*yield**/, __values$3(resolveChunks(childContextMaybeResolvable, request, function (childContext) {
                            return createMatcherIterator(child, __assign$2({}, request, { context: childContext || {} }));
                        }))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
    ...
    function createContext(maybeChildContextResolvable, maybeChildNodeResolvable) {
        {
    ...
    function createSwitch(options) {
        ...
        var mappedPaths = {};
        try {
            for (var _b = __values$4(Object.keys(options.paths)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var key = _c.value;
    ...
    function createRedirect(to, meta) {
        {
    ...
    function withState(stateMaybeResolvable, forceChild) {
        ...
        function stateMatcherGenerator(request, child) {
            return __generator$7(this, function (_a) {
                switch (_a.label) {
                    case 0: return [5 /*yield**/, __values$5(resolveChunks(stateMaybeResolvable, request, function (mergeState) {
                            var state = mergeState === null ? request.state : __assign$3({}, request.state, mergeState);
                            return concatMatcherIterators(chunks(mergeState === null ? [] : [createChunk('state', request, { state: state })]), createMatcherIterator(child, __assign$3({}, request, { state: state })));
                        }))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
        ...
        if (typeof options === 'function') {
            ...
            contextGetter = function getRoute(req, context) {
                ...
                if (!dataMaybePromise) {
                    ...
                    dataMaybePromise = dataMaybePromise.then(inputOrEmptyObject$1);
                }
                ...
                if (a || b || c || d || e || f || g) {
                    return (function () { return __awaiter$2(_this, void 0, void 0, function () {
                        var _a;
    ...
    function inputOrEmptyObject$1(x) {
        return x || {};
    }
    ...
    function withCrawlerPatterns(crawlablePatterns, forceChild) {
        ...
        var crawlerResolvable = function (request) {
            return function (pattern, parentRequest) { return __awaiter$3(_this, void 0, void 0, function () {
            ...
            return __generator$9(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [5 /*yield**/, __values$6(createMatcherIterator(child, request))];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 2: return [5 /*yield**/, __values$6(resolveChunks(crawlerResolvable, request, function (crawler) {
                            return createMatcherIterator(child, __assign$4({}, request, { crawler: crawler }));
                        }))];
                    case 3:
                        _a.sent();
                        _a.label = 4;
    ...
    var ChunksMapObservable = /** @class */ (function () {
        function ChunksMapObservable(url, rootContext, matcherGeneratorClass, rootMapping, router, options) {
            ...
            this.refresh = function () { return __awaiter$4(_this, void 0, void 0, function () {
                    ...
                    switch (_b.label) {
                        ...
                        case 3:
                            ...
                            Promise.race(allChunks
                                .filter(isBusy$2)
                                .map(pickChunkPromise$1)).then(handleUpdate, handleUpdate);
    ...
    function routeReducerWithoutCompat(route, chunk) {
        if (route) {
            if (chunk.type === 'url') {
                return __assign$5({}, route, { chunks: route.chunks.filter(function (chunk) { return chunk.type !== 'url'; }), url: chunk.url });
            }
            if (route.type !== 'ready') {
                return route;
            }
        ...
        switch (chunk.type) {
            case 'busy':
                return __assign$5({}, base, { type: 'busy' });
            case 'data':
                return __assign$5({}, base, { type: 'ready', data: __assign$5({}, base.data, chunk.data) });
            case 'error':
                return __assign$5({}, base, { type: 'error', error: chunk.error, status: (base.status && base.status >= 400) ? base.status : (chunk.error.status || 500) });
            case 'head':
                return __assign$5({}, base, { type: 'ready', heads: base.heads.concat(chunk.head) });
            case 'headers':
                return __assign$5({}, base, { type: 'ready', headers: __assign$5({}, base.headers, chunk.headers) });
            case 'redirect':
                return __assign$5({}, base, { type: 'redirect', to: chunk.to });
            case 'state':
                return __assign$5({}, base, { type: 'ready', data: __assign$5({}, base.state, chunk.state) });
            case 'status':
                return __assign$5({}, base, { type: 'ready', status: chunk.status });
            case 'title':
                return __assign$5({}, base, { type: 'ready', title: chunk.title });
            case 'view':
                return __assign$5({}, base, { type: 'ready', views: base.views.concat(chunk.view) });
            default:
                return __assign$5({}, base, { type: 'ready' });
        }
    }
            ...
            return __generator$b(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        crawler = function (pattern, parentRequest) { return __awaiter$5(_this, void 0, void 0, function () {
                            var patterns;
                            return __generator$b(this, function (_a) {
                                switch (_a.label) {
    ...
    function resolve(options) {
        return __awaiter$6(this, void 0, void 0, function () {
            ...
            return __generator$c(this, function (_a) {
                basename = options.basename, context = options.context, routes = options.routes, url = options.url, urls = options.urls, routerResolveOptions = __rest$2(options, ["basename", "context", "routes", "url", "urls"]);
                if (url && urls) {
    ...
    var Navigation = /** @class */ (function () {
            ...
            this.handleChunkList = function (chunks) {
                ...
                for (var i = 0; i < chunks.length; i++) {
                    ...
                    if (chunk.type === 'state') {
                        ...
                        _this._history.replace(__assign$6({}, location, { state: setLocationRequestState(location.state, chunk.state) }));
                    }
                    if (chunk.type === 'redirect') {
                        var revertedState = revertLocationState(location.state);
                        if (revertedState) {
                            _this.ignoreNextLocationChange = true;
                            _this._history.replace(__assign$6({}, location, { state: revertedState }));
         ...
         */
        Navigation.prototype.getSteadyValue = function () {
            return __awaiter$7(this, void 0, void 0, function () {
                return __generator$d(this, function (_a) {
                    {
        ...
        Navigation.prototype.steady = function () {
            return __awaiter$7(this, void 0, void 0, function () {
                return __generator$d(this, function (_a) {
                    switch (_a.label) {
                        case 0:
        ...
        Navigation.prototype.handleLocationChange = function (location, force) {
            ...
            if (this.trailingSlash !== null) {
                ...
                if (location.pathname !== modifiedPathname) {
                    this._history.replace(__assign$6({}, location, { pathname: modifiedPathname }));
                    return;
                }
            }
    ...
    function setLocationRequestState(locationState, newState) {
        ...
        var _a;
        return __assign$6({}, newState, (_a = {}, _a[NAVI_STATE_KEY] = locationState[NAVI_STATE_KEY], _a));
    }
    function packLocationState(_a) {
        var _b;
        var revertTo = _a.revertTo, state = _a.state, requestDataWithoutState = __rest$3(_a, ["revertTo", "state"]);
        if (revertTo) {
        ...
        return __assign$6({}, state, (_b = {}, _b[NAVI_STATE_KEY] = {
    ...
    function unpackLocationState(state) {
        ...
        return __assign$6({}, naviState.requestDataWithoutState, { state: Object.keys(requestDataState).length ? requestDataState : undefined });
    }
    ...
    function createBrowserNavigation(options) {
        ...
        if (options.state) {
            history$1.replace(__assign$7({}, history$1.location, { state: options.state }));
        }
    ...
    function createMemoryNavigation(options) {
        ...
        navigation.navigate(__assign$8({}, options.request, { url: url, replace: true }));
        return navigation;
    }
