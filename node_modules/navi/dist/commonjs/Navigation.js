        ...
        this.handleChunkList = function (chunks) {
            ...
            for (var i = 0; i < chunks.length; i++) {
                ...
                if (chunk.type === 'state') {
                    ...
                    _this._history.replace(__assign({}, location, { state: setLocationRequestState(location.state, chunk.state) }));
                }
                if (chunk.type === 'redirect') {
                    var revertedState = revertLocationState(location.state);
                    if (revertedState) {
                        _this.ignoreNextLocationChange = true;
                        _this._history.replace(__assign({}, location, { state: revertedState }));
    ...
    Navigation.prototype.handleLocationChange = function (location, force) {
        ...
        if (this.trailingSlash !== null) {
            ...
            if (location.pathname !== modifiedPathname) {
                this._history.replace(__assign({}, location, { pathname: modifiedPathname }));
                return;
            }
        }
...
function setLocationRequestState(locationState, newState) {
    ...
    var _a;
    return __assign({}, newState, (_a = {}, _a[NAVI_STATE_KEY] = locationState[NAVI_STATE_KEY], _a));
}
function packLocationState(_a) {
    ...
    return __assign({}, state, (_b = {}, _b[NAVI_STATE_KEY] = {
...
function unpackLocationState(state) {
    ...
    return __assign({}, naviState.requestDataWithoutState, { state: Object.keys(requestDataState).length ? requestDataState : undefined });
}
