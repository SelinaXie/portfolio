...
exports.createRootMapping = createRootMapping;
function createMapping(pattern, matcher) {
    ...
    for (var i = 0; i < parts.length; i++) {
        ...
        if (part.length > 1 && part[0] === ':') {
            ...
            keyParts.push(exports.KEY_WILDCARD);
            regExpParts.push('([^/]+)');
        }
        else {
            keyParts.push(part);
...
exports.matchAgainstPathname = matchAgainstPathname;
