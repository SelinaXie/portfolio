...
var withView_1 = require("./withView");
...
var withTitle_1 = require("./withTitle");
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        titlePromise = options.getTitle
                            ? Promise.resolve(options.getTitle(req, context, metaPromise)).then(Resolvable_1.extractDefault)
                            : Promise.resolve(options.title);
                        if (req.method !== 'HEAD') {
                            contentPromise = options.getContent
                                ? Promise.resolve(options.getContent(req, context, metaPromise)).then(Resolvable_1.extractDefault)
...
function createPage(options) {
    ...
    return Object.assign(compose_1.compose(withContext_1.withContext(createGetPage(options)), withData_1.withData(function (req, context) { return context.meta; }), withTitle_1.withTitle(function (req, context) { return context.title; }), withView_1.withView(function (req, context) { return context.content; })), { isDeprecatedMatcher: true });
}
...
function createContext(maybeChildContextResolvable, maybeChildNodeResolvable) {
    ...
    return Object.assign(withContext_1.withContext(maybeChildContextResolvable, maybeChildNodeResolvable.isDeprecatedMatcher
        ? maybeChildNodeResolvable
        : map_1.map(maybeChildNodeResolvable)), { isDeprecatedMatcher: true });
}
...
function createSwitch(options) {
    ...
    try {
        for (var _b = __values(Object.keys(options.paths)), _c = _b.next(); !_c.done; _c = _b.next()) {
            ...
            mappedPaths[key] = matcher.isDeprecatedMatcher ? matcher : map_1.map(matcher);
        }
    }
    ...
    if (Object.keys(options).length === 1) {
        return Object.assign(mount_1.mount(mappedPaths), { isDeprecatedMatcher: true });
    }
    else {
        var paths = options.paths, pageOptions = __rest(options, ["paths"]);
        return Object.assign(compose_1.compose(withContext_1.withContext(createGetPage(pageOptions)), withData_1.withData(function (req, context) { return context.meta; }), withTitle_1.withTitle(function (req, context) { return context.title; }), withView_1.withView(function (req, context) { return context.content; }), mount_1.mount(mappedPaths)), { isDeprecatedMatcher: true });
    }
}
...
function createRedirect(to, meta) {
    ...
    var matcher = redirect_1.redirect(to);
    if (meta) {
        return compose_1.compose(withData_1.withData(meta), matcher);
    }
